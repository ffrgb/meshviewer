define(['map', 'sidebar', 'tabs', 'container', 'legend',
  ...
  function (Map, Sidebar, Tabs, Container, Legend, Linklist,
            Nodelist, SimpleNodelist, Infobox, Proportions, ForceGraph,
            Title, About, DataDistributor, FilterGUI, HostnameFilter) {
    'use strict';

    return function (router, language) {
      var self = this;
      var content;
      var contentDiv;
      ...
      function addContent(K) {
        ...
        content = new K(sidebar.getWidth, router, buttons);
      ...
      var infobox = new Infobox(sidebar, router);
      var tabs = new Tabs();
      ...
      var linklist = new Linklist(router);
