define(['map/clientlayer', 'map/labellayer', 'leaflet', 'moment', 'map/locationmarker', 'rbush', 'helper', 'utils/constance'],
  function (ClientLayer, LabelLayer, L, moment, LocationMarker, rbush, helper, constance) {
    'use strict';
    ...
    function addLinksToMap(dict, graph, router) {
      ...
      return graph.map(function (d) {
        var opts = {
          color: constance.linkScale(1 / d.tq),
          weight: 4,
          opacity: 0.5,
          dashArray: 'none'
        };
