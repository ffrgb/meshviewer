define(['sorttable', 'virtual-dom', 'helper', 'utils/constance'], function (SortTable, V, helper, constance) {
  'use strict';
  ...
  return function (router) {
    ...
    function renderRow(d) {
      ...
      var td2 = V.h('td', { style: { color: constance.linkScale(1 / d.tq) } }, helper.showTq(d));
