define(['sorttable', 'virtual-dom', 'moment', 'helper', 'utils/scales'],
  function (SortTable, V, moment, helper, scales) {
    'use strict';
    ...
    return function (el, router, d) {
      function renderNeighbourRow(n) {
        ...
        var td4 = V.h('td', { style: { color: scales.link(1 / n.link.tq) } }, helper.showTq(n.link));
