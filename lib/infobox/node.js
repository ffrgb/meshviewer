define(['sorttable', 'virtual-dom', 'moment', 'helper', 'utils/constance'],
  function (SortTable, V, moment, helper, constance) {
    'use strict';
    ...
    return function (el, router, d) {
      function renderNeighbourRow(n) {
        ...
        var td4 = V.h('td', { style: { color: constance.linkScale(1 / n.link.tq) } }, helper.showTq(n.link));
      ...
      helper.attributeEntry(attributes, 'node.site', showSite(d));
